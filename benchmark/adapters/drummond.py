...
class DrummondAdapter(CandidateAdapter):
    """
    Adapter para o Drummond-1b1-Instruct (RafaelQueiroz/drummond-1b1-instruct).
    Fine-tune do Tucano-1b1 para instruções e raciocínio em português.
    """

    def __init__(self, model_name="RafaelQueiroz/drummond-1b1-instruct", device="cpu"):
