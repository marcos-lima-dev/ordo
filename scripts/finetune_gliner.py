...
def main():
    ...
    train_data = load_dataset("datasets/gliner_train.jsonl")
    val_data = load_dataset("datasets/gliner_val.jsonl")
    ...
    # Tokenizer do GLiNER (é o mesmo do BERT)
    print("Carregando tokenizer...")
    tokenizer = AutoTokenizer.from_pretrained("bert-base-uncased")
    print("Tokenizer carregado com sucesso.")

    # Carrega o modelo base para token classification
    ...
    training_args = TrainingArguments(
        output_dir="./gliner_finetuned_model",
        num_train_epochs=10,
    ...
    model.save_pretrained("./gliner_finetuned_model")
    tokenizer.save_pretrained("./gliner_finetuned_model")
    print("Modelo salvo em ./gliner_finetuned_model")
