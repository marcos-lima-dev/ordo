...
def compute_metrics(p):
    ...
    # Retorna um dicionário com as métricas, incluindo a acurácia por entidade
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        # CORRIGIDO: usa eval_loss (escalar) como métrica para selecionar o melhor modelo
    ...
    model.save_pretrained("./models/entity_ner")
    tokenizer.save_pretrained("./models/entity_ner")
    print("Modelo salvo em ./models/entity_ner")
